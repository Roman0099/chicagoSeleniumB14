...
public class SmartBearTask {
    ...
    public static void verifyOrder(WebDriver driver, String names){
        List<WebElement> allNames = driver.findElements(By.xpath("//table[@id='ctl00_MainContent_orderGrid']/tbody/tr/td[2]"));
        for(WebElement name : allNames){
            if(name.getText().equals(name)){
                System.out.println(name + " exists in the list. Verification PASSED!");
                return;
            }
        }
        System.out.println(names + "does NOT exist in the list. Verification FAILED!!!");
    }
